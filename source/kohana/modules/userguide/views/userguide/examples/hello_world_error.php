...
<div id="kohana_error">
<h1><span class="type">Kohana_View_Exception [ 0 ]:</span> <span class="message">The requested view site could not be found</span>
</h1>
	...
	<p>
					...
					<span class="file">
													<a href="#error4ac2453378034source0"
													   onclick="return koggle('error4ac2453378034source0')">SYSPATH/classes/kohana/view.php
														[ 115 ]</a>
											</span>
		&raquo;
			...
			<tr>
				...
				<td>
					<pre><small>string</small><span>(4)</span> "site"</pre>
													...
													<pre id="error4ac2453378034source0" class="source collapsed"><code><pre
																class="source"><code><span class="line"><span
	...
	<p>
					<span class="file">
													<a href="#error4ac2453378034source1"
													   onclick="return koggle('error4ac2453378034source1')">SYSPATH/classes/kohana/view.php
														[ 26 ]</a>
											</span>
		&raquo;
			...
			<tr>
				...
				<td>
					<pre><small>NULL</small></pre>
													...
													<pre id="error4ac2453378034source1" class="source collapsed"><code><pre
																class="source"><code><span class="line"><span
																			class="number">21</span> 	 * @param   array   array of values
	...
	<p>
					...
					<span class="file">
													<a href="#error4ac2453378034source2"
													   onclick="return koggle('error4ac2453378034source2')">SYSPATH/classes/kohana/controller/template.php
														[ 32 ]</a>
											</span>
		&raquo;
			...
			<tr>
				...
				<td>
					<pre><small>string</small><span>(4)</span> "site"</pre>
													...
													<pre id="error4ac2453378034source2" class="source collapsed"><code><pre
																class="source"><code><span class="line"><span
																			class="number">27</span> 	public function before()
</span><span class="line"><span class="number">28</span> 	{
	...
	<p>
					<span class="file">
													<a href="#error4ac2453378034source4"
													   onclick="return koggle('error4ac2453378034source4')">SYSPATH/classes/kohana/request.php
														[ 840 ]</a>
											</span>
		&raquo;
		...
		<table cellspacing="0">
			<tr>
				...
				<td><pre><small>object</small> <span>Controller_Hello(3)</span> <code>{
							...
							request =>
							<small>object</small>
							<span>Request(9)</span> <code>{
								<small>public</small>
								route =>
								<small>object</small>
								<span>Route(4)</span> <code>{
									<small>protected</small>
									_uri =>
									<small>string</small>
									<span>(32)</span> "(&lt;controller&gt;(/&lt;action&gt;(/&lt;id&gt;)))"
									<small>protected</small>
									_regex =>
									<small>array</small>
									<span>(0)</span>
                ...
                "action" => <small>string</small><span>(5)</span> "index"
									...
									_route_regex =>
									<small>string</small>
									<span>(87)</span> "#^(?:(?P&lt;controller&gt;[^/.,;?]++)(?:/(?P&lt;action&gt;[^/.,;?]++)(?:/(?P&lt;id&gt;[^/.,;?]++))?)?)?$#"
									}</code>
								<small>public</small>
								status =>
								<small>integer</small>
            ...
            "Content-Type" => <small>string</small><span>(24)</span> "text/html; charset=utf-8"
								...
								<span>(0)</span>
													...
													<pre id="error4ac2453378034source4" class="source collapsed"><code><pre
																class="source"><code><span class="line"><span
																			class="number">835</span>
	...
	<p>
					<span class="file">
													<a href="#error4ac2453378034source5"
													   onclick="return koggle('error4ac2453378034source5')">APPPATH/bootstrap.php
														[ 76 ]</a>
		...
		Kohana_Request->execute()
													...
													<pre id="error4ac2453378034source5" class="source collapsed"><code><pre
																class="source"><code><span class="line"><span
	...
	<p>
					<span class="file">
													<a href="#error4ac2453378034source6"
													   onclick="return koggle('error4ac2453378034source6')">DOCROOT/index.php
														[ 106 ]</a>
											</span>
		&raquo;
	...
	<div id="error4ac2453378034args6" class="collapsed">
		<table cellspacing="0">
			<tr>
				...
				<td>
					<pre><small>string
						</small><span>(49)</span> "/var/www/kohana/testing/application/bootstrap.php"</pre>
				</td>
			</tr>

		</table>
	</div>
													<pre id="error4ac2453378034source6" class="source collapsed"><code><pre
																class="source"><code><span class="line"><span
																			class="number">101</span> 	// Load empty core extension
...
<h2><a href="#error4ac2453378034environment" onclick="return koggle('error4ac2453378034environment')">Environment</a>
</h2>

<div id="error4ac2453378034environment" class="content collapsed">
<h3><a href="#error4ac2453378034environment_included" onclick="return koggle('error4ac2453378034environment_included')">Included
		files</a> (31)</h3>
...
<h3><a href="#error4ac2453378034environment_loaded" onclick="return koggle('error4ac2453378034environment_loaded')">Loaded
		extensions</a> (41)</h3>
...
<h3><a href="#error4ac2453378034environment_server" onclick="return koggle('error4ac2453378034environment_server')">$_SERVER</a>
</h3>
...
"</pre>
		...
		<tr>
			...
			<td>
				<pre><small>string</small><span>(33)</span> "/var/www/kohana/testing/index.php"</pre>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<pre><small>string</small><span>(31)</span> "/kohana/testing/index.php/hello"</pre>
			</td>
		</tr>
		<tr>
			<td><code>SCRIPT_NAME</code></td>
			<td>
				<pre><small>string</small><span>(25)</span> "/kohana/testing/index.php"</pre>
			</td>
