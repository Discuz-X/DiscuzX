		...
		<div class="container">
			...
			<div id="kodoc-body" class="span-16 suffix-1 last">
				...
				<?php if($show_comments): ?>
					...
					<noscript>Please enable JavaScript to view the <a href="http://disqus.com/?ref_noscript=kohana">comments
...
<div id="kodoc-footer">
	<div class="container">
		...
		<div class="span-12 last right">
			<p>Powered by <?php echo HTML::anchor('http://kohanaframework.org/', 'Kohana') ?>
				v<?php echo Kohana::VERSION ?></p>
		</div>
	</div>
</div>
