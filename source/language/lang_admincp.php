...
(
    ...
    'perpage_200' => '每页显示200个',//增加列表选项标示
    'perpage_500' => '每页显示500个',//增加列表选项标示
	'multiedit' => '批量编辑',
	'show_search' => '显示搜索框',
	'hide_search' => '隐藏搜索框',
	'keywords' => '关键词',
	...
	'home_sys_info' => '系统信息',
	'home_discuz_version' => 'WebPower! 程序版本',//WebPower 版 修改程序标识
...
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'portalcategory_allowlistshowothers' => '列表页边栏显示其他分类',//WebPower版列表页边栏显示其他分类
	'portalcategory_allowlistshowothers_comment' => '设置此频道下列表页边栏是否显示其他分类列表',//WebPower版设置此频道下列表页边栏是否显示其他分类列表
	'portalcategory_allowviewshowothers' => '文章页边栏显示其他分类',//WebPower版文章页边栏显示其他分类
	'portalcategory_allowviewshowothers_comment' => '设置此频道下文章页边栏是否显示其他分类列表',//WebPower版设置此频道下文章页边栏是否显示其他分类列表
	'portalcategory_allowviewshowsubs' => '文章页边栏显示子分类',//WebPower版文章页边栏显示子分类
